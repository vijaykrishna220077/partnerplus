        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1">
          ...
          {remainingSlots > 0 && !isUploading && (
            <div className="grid grid-cols-2 gap-3">
              {/* Take Photo Button */}
              <label className="p-4 rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50/50 hover:bg-blue-50 hover:border-blue-500 transition cursor-pointer flex flex-col items-center justify-center text-center space-y-1.5 group">
