      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-4 sm:mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E8F7FC] text-[#0284C7] text-xs sm:text-sm font-black tracking-wide uppercase shadow-2xs border border-sky-200">
            ...
            <span>THE STANDARD FOR COMMERCIAL</span>
          </div>
          {onSwitchToWorker && (
            <button
            ...
            >
              <span>👷 Worker Portal (कामगार)</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </button>
          )}
        </div>

        {/* H1 Main Title matching Screenshot */}
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-[64px] font-black text-[#0F172A] tracking-tight leading-[1.08] font-display max-w-4xl mx-auto">
          Pressure Washing,<br className="hidden sm:inline" />
          {' '}Window Cleaning &amp;<br className="hidden sm:inline" />
          {' '}Fleet Wash
        </h1>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-2 max-w-3xl mx-auto text-xs sm:text-sm font-bold text-gray-600">
          <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">💧 Commercial Pressure Washing</span>
          <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">✨ Window Detailing</span>
          <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">🚛 Fleet &amp; Vehicle Washing</span>
          <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">⚡ Commercial Electrician</span>
          <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">🚰 Commercial Plumbing</span>
        </div>
        ...
        <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <span className="truncate">Check Our Prices</span>
            </div>
          ...
          >
            ...
            <span>214-550-5563 (Commercial Dispatch)</span>
          </button>
        </div>
      </div>

      {/* Vector City & Cleaning Crew Illustration Canvas */}
